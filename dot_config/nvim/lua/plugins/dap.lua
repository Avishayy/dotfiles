  ...
  },
  {
    ...
    config = function()
      ...
      require("dap-vscode-js").setup {
        ...
        debugger_path = "/Users/avishay/.local/share/nvim/lazy/vscode-js-debug", -- Path to vscode-js-debug installation.
      ...
      require("dap").configurations.typescript = {
        {
          ...
          type = "pwa-node",
          request = "launch",
          runtimeExecutable = "ts-node", -- Use ts-node to run TypeScript
          args = { "${file}" }, -- Run the current file
